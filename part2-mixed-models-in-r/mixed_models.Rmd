...
- whether data has only a single random-effects grouping factor, crossed random-effects grouping factor, or nested random-effects grouping factor, random-effects parameters is only mechanism for handling dependencies
